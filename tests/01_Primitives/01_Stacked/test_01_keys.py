...
@pytest.mark.parametrize("failed_data, failed_msg", [
    ([1, 2, 3], "update() argument must be a mapping or iterable of pairs, got list (expected: Mapping, got: list)"),
    (1, "update() argument must be a mapping or iterable of pairs, got int (expected: Mapping, got: int)")
])
